...
import {  SubmissionUploadFileAccessConditionObject } from '../../../../../app/core/submission/models/submission-upload-file-access-condition.model';
...
export class AccessConditionsComponent {
  ...
  getAccessConditionIcon(access: SubmissionUploadFileAccessConditionObject) {
    switch (access.name.toLowerCase()) {
      case 'openaccess': return 'fa-unlock';
