...
@Component({
  template: `
      <div class="row mt-1" *ngIf="hasValidMetadata('dissertation.faculty')">
      ...
      <div class="row mt-1" *ngIf="hasValidMetadata('dissertation.degree.name')">
      ...
      <div class="row mt-1" *ngIf="hasValidMetadata('dissertation.defenseDate')">
